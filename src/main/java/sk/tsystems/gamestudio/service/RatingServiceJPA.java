...
public class RatingServiceJPA implements RatingService {
	...
	{Double x = (Double) entityManager.createQuery("Select Avg(r.value) from Rating r where r.game = :game").setParameter("game", game).setParameter("game", game).getSingleResult();
